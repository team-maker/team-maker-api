...
from .team_group_player_serializer import TeamGroupPlayerSerializer, TeamGroupPlayerWithPointsSerializer
...
from .game_available_player_serializer import GameAvailablePlayerSerializer